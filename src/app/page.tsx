...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      color: "bg-cyan-50",
      accent: "border-turquoise-primary",
      image: "/images/kanalizasyon.jpeg"
    }
  ];
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 pb-20 md:pb-0">
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <a href="https://wa.me/905352456603?text=Merhaba,%20fiyat%20almak%20istiyorum." target="_blank" className="bg-white border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white px-8 py-4 rounded-xl font-black text-lg transition-all flex items-center justify-center gap-3 shadow-md group">
                  <WhatsAppIcon className="w-6 h-6 text-[#25D366] group-hover:text-white transition-colors" /> Fotoğraf Gönder Fiyat Al
                </a>
              </div>
      ...
      <section id="galeri" className="py-24 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-fire-red font-black uppercase tracking-widest text-sm mb-3">İşimiz Konuşsun</h2>
          <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-16">Galeri & Tamamlanan İşler</h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((num) => {
              const isVideo = num === 5;
              const src = isVideo ? `/images/yapilanislem${num}.mp4` : `/images/yapilanislem${num}.jpeg`;

              return (
                <div key={num} className="group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 aspect-square bg-slate-50">
                  {isVideo ? (
                    <video
                      src={src}
                      autoPlay
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                    <div className="text-left w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                      <span className="text-turquoise-primary font-black text-xs uppercase tracking-widest block mb-1">REFERANS</span>
