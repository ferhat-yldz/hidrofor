...
import {
  ...
  Users, ThumbsUp, HelpCircle, MessageCircle, ArrowRight, Menu, X
} from "lucide-react";
  ...
  const services = [
    {
      ...
      image: "/images/detaylıkombibakimi.jpeg"
    },
    {
      ...
      image: "/images/cihazlı su kaçaktespiti.jpeg"
    },
    {
      ...
      color: "bg-cyan-50",
      accent: "border-turquoise-primary",
      image: "/images/İLAÇSIZ DARBELİ PETEKE TAMİZLİĞİ.jpeg"
    },
    {
      ...
      image: "/images/Yazlık kışlık güneş enerji sistemi kurulumu.JPEG"
    },
    {
      ...
      image: "/images/TERMOSİFON MONTAJI SATIŞI.jpeg"
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                ...
                <a href="https://wa.me/905352456603?text=Merhaba,%20fiyat%20almak%20istiyorum." target="_blank" className="bg-white border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white px-8 py-4 rounded-xl font-black text-lg transition-all flex items-center justify-center gap-3 shadow-md">
                  <MessageCircle className="w-6 h-6" /> Foto Gönder Fiyat Al
                </a>
              </div>
          ...
          <div className="p-8 border-t border-slate-50 bg-slate-50/50 mt-auto">
            <div className="flex flex-col gap-4 text-center">
              ...
              <a href="https://wa.me/905352456603" target="_blank" className="flex items-center justify-center gap-3 text-lg font-black text-slate-900 hover:text-[#25D366] transition-colors">
                <MessageCircle className="w-6 h-6 text-[#25D366]" /> WhatsApp Destek
              </a>
            </div>
